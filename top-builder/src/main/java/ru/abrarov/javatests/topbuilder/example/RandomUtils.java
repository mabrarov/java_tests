...
public class RandomUtils {
	 ...
	 * @param min
	 *            Minimum value of generated integer. Must be <= max.
	 * @param max
	 *            Maximum value of generated integer. Must be >= min.
	 ...
	 * 
	 * @param alphabet
	 *            Alphabet to be used in string generation. Must be not empty.
	 * @param length
	 *            Length of the generated string. Must be >= 0.
	 * @param random
	 *            Random generator to be used.
	 ...
	 * 
	 * @param values
	 *            Collection of values used to fill generated list.
	 * @param listSize
